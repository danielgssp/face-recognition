...
import kotlinx.android.synthetic.main.both_services.*
import java.io.IOException
import java.util.*

class BothServices : CameraActivity(), ImageReader.OnImageAvailableListener {
    ...
    private fun initToolbar(){
        toolbar.tvBarTitle.text = "Both Services"
